...
import ergo.dataacess.SpmRepository;
...
public class SpmService {
     ...
     * @throws Exception 
     */
    public int insert(Boolean baseBeBool, String baseBeNotes, Boolean baseAfBool, String baseAfNotes,
            Boolean shoulderBeBool, String shoulderBeNotes, Boolean shoulderAfBool, String shoulderAfNotes,
            Boolean armBeBool, String armBeNotes, Boolean armAfBool, String armAfNotes) throws Exception{
        
        sr = new SpmRepository();
        Spm spm = new Spm();
        spm.setArmAfBool(armAfBool);
        spm.setArmAfNotes(armAfNotes);
        spm.setArmBeBool(armBeBool);
        spm.setArmBeNotes(armBeNotes);
        spm.setBaseAfBool(baseAfBool);
        spm.setBaseAfNotes(baseAfNotes);
        spm.setBaseBeBool(baseBeBool);
        spm.setBaseBeNotes(baseBeNotes);
        spm.setShoulderAfBool(shoulderAfBool);
        spm.setShoulderAfNotes(shoulderAfNotes);
        spm.setShoulderBeBool(shoulderBeBool);
        spm.setShoulderBeNotes(shoulderBeNotes);
        return sr.insert(spm);
    }
     ...
     */
    public int remove(Integer spmId)throws Exception{
        sr = new SpmRepository();
        Spm spm = sr.getSpm(spmId);
        return sr.delete(spm);
    }
     ...
     */
    public int update(Integer spmId, Boolean baseBeBool, String baseBeNotes, Boolean baseAfBool, String baseAfNotes,
            Boolean shoulderBeBool, String shoulderBeNotes, Boolean shoulderAfBool, String shoulderAfNotes,
            Boolean armBeBool, String armBeNotes, Boolean armAfBool, String armAfNotes) throws Exception{
        sr = new SpmRepository();
        Spm spm = sr.getSpm(spmId);
     ...
     */
    public Spm getSpm(int spmId)throws Exception{
        sr = new SpmRepository();
        return sr.getSpm(spmId);
    }
     ...
     */
    public List<Spm> getAll() throws Exception{
        sr = new SpmRepository();
        return sr.getAll();
    }
}
